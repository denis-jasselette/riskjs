...
const PlayerInfo = (props: PlayerInfoProps) => {
  ...
  const isConcealed = gameState.fogEnabled && viewingPlayer !== props.playerConfig.color
  ...
  return (
    ...
    >
      ...
      <div className={style.PlayerInfoStats}>
        <div className={style.PlayerInfoTroops} data-concealed={isConcealed}>
          ...
          {isConcealed ? '?' : gameController.getPlayerTroopTotal(props.playerConfig.color)}
        </div>
        <div className={style.PlayerInfoTerritories} data-concealed={isConcealed}>
          ...
          {isConcealed ? '?' : gameController.getPlayerTerritoryTotal(props.playerConfig.color)}
        </div>
