...
export function App() {
  ...
  const handleStart = ({ playerCount, blizzards, fog, capitalMode }: HandleStartParams) => {
    ...
    setGameState(GameLogic.initState(mapConfig, playerConfigs, blizzards, false, fog, capitalMode))
  }
