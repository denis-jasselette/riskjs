...
- What happens visually for an obscured territory — does it show as
  "unowned"/neutral-looking, or as some clearly-distinct "unknown" state that
  doesn't imply any particular ownership status?
